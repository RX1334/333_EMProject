...
def lab_info():
    ...
    dict = {'rabinowitz_icahn_201-today-kwh': str(round(lab_energy*12.379, 2)) + ' kWh', 
        ...
        'rabinowitz_icahn_201-temperature': str(round(temp)) + ' degrees',
        ...
        'rabinowitz_icahn_201-chart-data': {
            ...
            'sixMonths': {'labels': ['5/2021', '6/2021', '7/2021', '8/2021', '9/2021', '10/2021'], 'time': [383.382, 392.229, 402.225, 410.202, 402.225, 410.202]}, 
